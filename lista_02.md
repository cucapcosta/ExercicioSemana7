...
R: Nenhuma das acima está correta, a compra 2 é aprovada com 0 de saldo
...
var velocidadeAtual = velocidadeInicial
var tempo

enquanto (distanciaAtual < distanciaTotal):
    se (velocidadeMaxima > velocidadeAtual + aceleracao):
